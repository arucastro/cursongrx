...
export const enum usuariosTypeActions {
  ...
  UPDATE_USUARIO = '[UPDATE_USUARIO] CREATE USUARIO',
  UPDATE_USUARIO_SUCESS = '[UPDATE_USUARIO_SUCESS] CREATE USUARIO SUCCESS',
  UPDATE_USUARIO_FAIL = '[UPDATE_USUARIO_FAIL] CREATE USUARIO FAIL',
